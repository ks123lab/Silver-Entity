  ...
  return (
    ...
    <section className="py-24 bg-gray-800 text-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Subtitle */}
         <p className="text-[14px] font-semibold uppercase text-white mb-2 font-archivo">
            — OUR PROCESS
          </p>
        
        {/* Main Title */}
        <h2 className="text-4xl md:text-[43px] font-extrabold text-white mb-0 font-archivo " data-aos="fade-up" data-aos-delay="300"  data-aos-duration="1200">
          Empowering You for <br className="hidden sm:inline" /> 
        </h2>
          <h2 className="text-4xl md:text-[43px] font-light text-white mb-16 -mt-10 font-archivo " data-aos="fade-up" data-aos-delay="400"  data-aos-duration="1200">
        ...
        <div className="relative">
            ...
            {processSteps.map((step, index) => (
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-gray-100 mb-3 font-archivo"data-aos="fade-up" data-aos-delay="600"  data-aos-duration="1200">
                    {step.title}
                </h3>

                {/* Description */}
                <p className="text-gray-200 leading-relaxed max-w-xs font-archivo text-base" data-aos="fade-up" data-aos-delay="800"  data-aos-duration="1200">
                    {step.description}
                </p>
                </div>
            ))}
