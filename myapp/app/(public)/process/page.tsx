  ...
  return (
    ...
    <section className="py-24 bg-[#544c38] text-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Subtitle */}
        <p className="text-sm font-semibold uppercase text-[#a3b18a] mb-3 font-archivo">
          — OUR SIMPLE 4-STEP PROCESS —
        </p>
        
        {/* Main Title */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-16 font-archivo leading-snug">
        ...
        <div className="relative">
            ...
            {processSteps.map((step, index) => (
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-gray-100 mb-3 font-archivo">
                    {step.title}
                </h3>

                {/* Description */}
                <p className="text-gray-200 leading-relaxed max-w-xs font-archivo text-base">
                    {step.description}
                </p>
                </div>
            ))}
